...
<table>
  ...
  <tbody>
    ...
    <tr><td><code>AGENT_BROWSER_IDLE_TIMEOUT_MS</code></td><td>Auto-shutdown the daemon after N ms of inactivity (no commands received). Set <code>0</code> to disable.</td><td><code>7200000</code> (2 hours)</td></tr>
    <tr><td><code>AGENT_BROWSER_MAX_AGE_MS</code></td><td>Maximum daemon lifetime in ms, regardless of activity. Backstop against leaked daemons. Set <code>0</code> to disable.</td><td><code>86400000</code> (24 hours)</td></tr>
